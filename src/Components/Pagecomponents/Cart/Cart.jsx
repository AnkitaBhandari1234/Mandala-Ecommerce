    ...
    <div className="bg-[#FFF8E6]    ">
      ...
      <div className="w-[70%] mx-6 my-8 flex flex-col gap-7">
        ...
        <div className=" flex flex-col   ">
          {Product.map((val, i) => {
            return (
              <div className=" flex gap-5 bg-[#FCF2DD] items-center py-5 px-5 border-b-[1.5px] border-[#FFE9C1] shadow-[0px_1px_7px_0px_rgba(0,0,0,0.07)] ">
                <input
                  type="checkbox"
                  name="selesct"
                  value="selectall"
      ...
      <div className="bg-[#FCF2DD] flex flex-col  gap-4 h-fit mt-28 rounded-2xl  w-[420px] px-6 py-4 font-poppins shadow-[0px_1px_5px_0px_rgba(0,0,0,0.07)]  ">
        ...
        <div className="flex flex-row justify-between border-t-[1.5px] border-[#F9E3B8] pt-2">
          ...
          <button type="submit" className="bg-[#BA4A20] w-full  py-2.5 rounded-full text-[16px] font-[400] text-white">Proceed to Checkout</button>
          </NavLink>
      </div>
    </div>
    </div>
