          ...
          <div className="flex flex-col gap-4   ">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-start gap-3 ">
                <input type="radio" className="mt-1" />
                <p className="flex flex-col ">
                  <span className="text-[#3E2F1C] font-inter text-[13px] font-[500] tracking-[0.14px] capitalize">Direct Bank Transfer</span>
                  <span className="text-[#858585] text-[13px] font-[400] tracking-[0.3px]">Make payment directly through bank account.</span>
                </p>
              </div>
              <div className="flex items-start gap-3 ">
                <input type="radio" className="mt-1" />
                <p className="flex flex-col">
                  <span className="text-[#3E2F1C] font-inter text-[13px] font-[500] tracking-[0.14px] capitalize">digital wallet</span>
                  <span className="text-[#858585] text-[13px] font-[400] tracking-[0.3px]">Pay with your khalti, esewa</span>
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-2.5 mt-2 ">
              <h4 className="text-[#3E2F1C] text-[15px] font-[400] font-inter ">Review & Place Order</h4>
              ...
              <div className="flex gap-2">
                ...
                <p className="text-[#414141] text-[12px] font-inter font-[400]">
                  ...
                  I agree to the <span className="text-[#BA4A20]">Terms & conditions</span>, <span className="text-[#BA4A20]">Privacy policy</span> & <span className="text-[#BA4A20]">Return
                  policy</span>
                </p>
              </div>
              <div className="flex items-center gap-2">
                <input type="checkbox" />
                <span className="text-[#414141] text-[12px] font-inter font-[400]">Sign me up to the email list</span>
              </div>
            </div>
          </div>
          {/* order summary */}
