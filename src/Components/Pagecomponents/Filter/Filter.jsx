...
const Filter = () => {
  ...
  const [hidesubCategory,sethideshowCategory]=useState(null);
  return (
    
      <div className="bg-[#FCF2DD] w-[240px] rounded-lg shadow-[0px_2px_2px_0px_rgba(0,0,0,0.08)] py-2   ">
        <h1 className="text-[#757575] font-poppins text-[17px] font-[400] py-2 px-3  ">
          Filters
        </h1>
        {/* category */}
        <div className="">
          <h2 className="text-[#757575] font-poppins text-[16px] font-medium my-3 flex justify-between mx-3 ">
            Category
            <img src={Arrow} alt=""/>
          </h2>
          <div>
            {category.map((cat, index) => (
              <div key={index} className="mb-4 flex flex-col gap-2">
                ...
                <h2 className="font-medium text-[15px] font-poppins text-[#BA4A20]  ">{cat.title}</h2>
                <img src={Arrow} alt="" onClick={()=>sethideshowCategory(hidesubCategory===index ?null:index)} className="cursor-pointer" />
                </div>
                {
                ...
                <div className="ml-0.5 flex flex-col gap-1 border-t border-[#F4E9CA] pt-2">
                  {cat.subcategory.map((sub, subIndex) => (
                    <label key={subIndex} className=" text-[#757575] font-poppins text-[13px] font-medium flex items-center px-3 ">
